{
  den.aspects.apps.provides.anki = {
    #TODO: hardcoded user, idk how to do it differently
    sops = {
      "anki/username" = {
        path = "/home/kexan/.config/anki/username";
        owner = "kexan";
        group = "users";
        mode = "0600";
      };
      ...
      "anki/key" = {
        path = "/home/kexan/.config/anki/key";
        owner = "kexan";
        group = "users";
        mode = "0600";
      };
    ...
    in {
      programs.anki = {
        ...
        profiles."User 1".sync = lib.optionalAttrs (options ? sops) {
          usernameFile = "/home/kexan/.config/anki/username";
          keyFile = "/home/kexan/.config/anki/key";
        };
      };
